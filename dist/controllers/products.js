      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _products.ProductsModel.find(query);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            id = req.params.id;
            _context3.next = 4;
            return _products.ProductsModel.findById(id);
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = 4;
            return _products.ProductsModel.create({
              name: name,
...
var updateProduct = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var id, _req$body3, name, description, stock, price, item, productUpdated;
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 8:
            _context5.next = 10;
            return _products.ProductsModel.findByIdAndUpdate(id, {
              name: name,
              description: description,
              stock: stock,
              price: price
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            id = req.params.id;
            _context6.next = 4;
            return _products.ProductsModel.findByIdAndDelete(id);
